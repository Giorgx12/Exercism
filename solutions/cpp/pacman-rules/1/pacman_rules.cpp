...
bool can_eat_ghost(bool power_pellet_active, bool touching_ghost) {
    ...
    if (power_pellet_active == 1 && touching_ghost == 1){
        return 1;
    }
    else{
        return 0;
...
bool scored(bool touching_power_pellet, bool touching_dot) {
    ...
    if(touching_power_pellet == 1 || touching_dot == 1){
        return 1;
    }
else{
        return 0;
...
bool lost(bool power_pellet_active, bool touching_ghost) {
    ...
    if(power_pellet_active == 0 && touching_ghost == 1){
        return 1;
}
else{
    return 0;
...
bool won(bool has_eaten_all_dots, bool power_pellet_active,
    ...
    if(lost(power_pellet_active, touching_ghost) == 0 && has_eaten_all_dots == 1){
        return 1;
    }
    else{
        return 0;
